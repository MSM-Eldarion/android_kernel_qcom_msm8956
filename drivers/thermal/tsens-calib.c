...
#define S10_P1_MASK_0_8976			0xf8000000
#define S10_P1_MASK_1_8976			0x00000001
...
#define S0_P1_SHIFT_8976			8
#define S1_P1_SHIFT_8976			20
#define S2_P1_SHIFT_8976			0
#define S3_P1_SHIFT_8976			12
#define S4_P1_SHIFT_8976			8
#define S5_P1_SHIFT_8976			20
#define S6_P1_SHIFT_8976			0
#define S7_P1_SHIFT_8976			12
#define S8_P1_SHIFT_8976			3
#define S9_P1_SHIFT_8976			15
#define S10_P1_SHIFT_0_8976			27
#define S10_P1_SHIFT_1_8976			0

#define S0_P2_SHIFT_8976			14
#define S1_P2_SHIFT_8976			26
#define S2_P2_SHIFT_8976			6
#define S3_P2_SHIFT_8976			18
#define S4_P2_SHIFT_8976			14
#define S5_P2_SHIFT_8976			26
#define S6_P2_SHIFT_8976			6
#define S7_P2_SHIFT_8976			18
#define S8_P2_SHIFT_8976			9
#define S9_P2_SHIFT_8976			21
#define S10_P2_SHIFT_8976			1

#define CAL_SEL_MASK_8976			0x00000003
	...
	u32 *p2, u32 mode)
{
	int i;
	int num, den;
	int SLOPE_8956[TSENS_NUM_SENSORS_8976] = 
		{3313, 3275, 3320, 3246, 3279, 3257, 3234, 3269, 3255, 3239, 3286};
	...
	for (i = 0; i < tmdev->ctrl_data->num_sensors; i++) {
		...
		if (of_machine_is_compatible("qcom,msm8956")) {
			tmdev->sensor[i].slope = SLOPE_8956[i];
		} else {
			tmdev->sensor[i].slope = SLOPE_DEFAULT;
...
int calibrate_8976(struct tsens_device *tmdev)
{
	...
	switch (mode) {
	case TWO_PT_CALIB:
		base1 = (qfprom_cdata[2] &
				BASE1_MASK_8976) >> BASE1_SHIFT_8976;
		p2[0] = (qfprom_cdata[0] &
				S0_P2_MASK_8976) >> S0_P2_SHIFT_8976;
		p2[1] = (qfprom_cdata[0] &
				S1_P2_MASK_8976) >> S1_P2_SHIFT_8976;
		p2[2] = (qfprom_cdata[1] &
				S2_P2_MASK_8976) >> S2_P2_SHIFT_8976;
		p2[3] = (qfprom_cdata[1] &
				S3_P2_MASK_8976) >> S3_P2_SHIFT_8976;
		p2[4] = (qfprom_cdata[2] &
				S4_P2_MASK_8976) >> S4_P2_SHIFT_8976;
		p2[5] = (qfprom_cdata[2] &
				S5_P2_MASK_8976) >> S5_P2_SHIFT_8976;
		p2[6] = (qfprom_cdata[3] &
				S6_P2_MASK_8976) >> S6_P2_SHIFT_8976;
		p2[7] = (qfprom_cdata[3] &
				S7_P2_MASK_8976) >> S7_P2_SHIFT_8976;
		p2[8] = (qfprom_cdata[4] &
				S8_P2_MASK_8976) >> S8_P2_SHIFT_8976;
		p2[9] = (qfprom_cdata[4] &
				S9_P2_MASK_8976) >> S9_P2_SHIFT_8976;
		p2[10] = (qfprom_cdata[5] &
				S10_P2_MASK_8976) >> S10_P2_SHIFT_8976;
	...
	case ONE_PT_CALIB2:
		...
		p1[0] = (qfprom_cdata[0] &
				S0_P1_MASK_8976) >> S0_P1_SHIFT_8976;
		p1[1] = (qfprom_cdata[0] &
				S1_P1_MASK_8976) >> S1_P1_SHIFT_8976;
		p1[2] = (qfprom_cdata[1] &
				S2_P1_MASK_8976) >> S2_P1_SHIFT_8976;
		p1[3] = (qfprom_cdata[1] &
				S3_P1_MASK_8976) >> S3_P1_SHIFT_8976;
		p1[4] = (qfprom_cdata[2] &
				S4_P1_MASK_8976) >> S4_P1_SHIFT_8976;
		p1[5] = (qfprom_cdata[2] &
				S5_P1_MASK_8976) >> S5_P1_SHIFT_8976;
		p1[6] = (qfprom_cdata[3] &
				S6_P1_MASK_8976) >> S6_P1_SHIFT_8976;
		p1[7] = (qfprom_cdata[3] &
				S7_P1_MASK_8976) >> S7_P1_SHIFT_8976;
		p1[8] = (qfprom_cdata[4] &
				S8_P1_MASK_8976) >> S8_P1_SHIFT_8976;
		p1[9] = (qfprom_cdata[4] &
				S9_P1_MASK_8976) >> S9_P1_SHIFT_8976;
		p1[10] = (qfprom_cdata[4] &
				S10_P1_MASK_0_8976) >> S10_P1_SHIFT_0_8976;
		tmp = (qfprom_cdata[5] &
				S10_P1_MASK_1_8976) << S10_P1_SHIFT_1_8976;
		p1[10] |= tmp;
