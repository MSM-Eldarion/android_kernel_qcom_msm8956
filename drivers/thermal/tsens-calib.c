	...
	u32 *p2, u32 mode)
{
	...
	int SLOPE_8956[TSENS_NUM_SENSORS_8976] = {3313, 3275, 3320, 3246, 3279, 3257, 3234, 3269, 3255, 3239, 3286};
	#endif
...
int calibrate_8976(struct tsens_device *tmdev)
{
	...
	case ONE_PT_CALIB2:
		...
		p1[10] = (qfprom_cdata[4] & S10_P1_MASK_0_8976) >> S10_P1_SHIFT_0_8976;
		tmp = (qfprom_cdata[5] & S10_P1_MASK_1_8976) << S10_P1_SHIFT_1_8976;
		p1[10] |= tmp;
